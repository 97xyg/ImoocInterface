...
if __name__ == "__main__":
    ...
    suite.addTest(TestCase02('test_04'))
    suite.addTest(TestCase02('test_02'))
    suite.addTest(TestCase02('test_05'))
    suite.addTest(TestCase02('test_01'))
    suite.addTest(TestCase02('test_07'))
    tests = [TestCase02('test_06'),TestCase02('test_04'),TestCase02('test_02'),TestCase02('test_05'),TestCase02('test_01'),TestCase02('test_07')]
